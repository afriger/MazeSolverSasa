package com.sasa.test.maze_zero;
...
public class MazeZero
{
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        // reading the file
        BufferedReader in = new BufferedReader(new FileReader("C:/dev/__JavaProjects/MazeSolverSasa/src/com/sasa/test/maze_zero/simple_maze_20x30.txt"));
